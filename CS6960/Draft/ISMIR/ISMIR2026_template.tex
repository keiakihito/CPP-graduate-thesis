...
does not consistently improve retrieval performance. While higher-capacity models provide limited gains for structured tasks, these gains quickly saturate, and scaling effects are weak or absent for abstract semantic retrieval. These findings suggest that retrieval performance in small-scale archival settings depends more on the nature of the proxy task than on model size alone
\end{abstract}
...
\section{Conclusion}
This study examined the effect of embedding-model capacity on content-based music similarity retrieval in a small-scale classical music archive.The results show that increasing model capacity does not consistently improve retrieval performance. While higher-capacity models provide limited gains for structured tasks, these gains saturate, and scaling effects are weak or absent for abstract semantic retrieval. These findings suggest that retrieval performance in small-scale settings is governed more by the nature of the proxy task than by embedding-model capacity alone, highlighting the importance of aligning model complexity with the specific retrieval context.
