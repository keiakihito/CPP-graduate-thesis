...
\begin{document}
    ...
    % \input{bibliography/bib_info.tex}  % Phase 2: excluded from build; only cited refs printed
    \printbibliography[
        heading=bibintoc,
    ...
    %% V1.1: Appendices disabled for minimal thesis skeleton; uncomment to restore.
