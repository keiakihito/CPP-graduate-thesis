"""Inference-only MERT large embedding extractor for thesis experiments."""
...
class TransformerLargeEmbedder:
    """Inference-only large MERT embedder for fixed-length clip representations."""
    ...
    def __init__(
        ...
        try:
            ...
            raise ImportError(
                "TransformerLargeEmbedder requires 'torch' and 'transformers' "
