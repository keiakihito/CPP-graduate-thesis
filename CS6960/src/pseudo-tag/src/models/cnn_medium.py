"""Inference-only PANNs medium embedding extractor for thesis experiments."""
...
class CNNMediumEmbedder:
    """Inference-only medium CNN embedder backed by pretrained PANNs."""
