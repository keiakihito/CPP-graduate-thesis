...
For CNN-based models, capacity is controlled by the number of convolutional layers following the PANNs architecture:
\begin{itemize}
...
This study further investigates whether the effect of model capacity is conditioned by the structure of the retrieval task itself.
